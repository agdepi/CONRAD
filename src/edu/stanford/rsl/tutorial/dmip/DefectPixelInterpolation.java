...
public class DefectPixelInterpolation {
	...
	public static void main(String[] args) {
		...
		String filename = "/proj/i5dmip/gy27waki/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/testimg.bmp";
		String filenameMask = "/proj/i5dmip/gy27waki/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mask.bmp";
		...
		//Multiplizieren von ideal image mit mask image
		...
		boolean zeroPadding = true; // to get a higher resulution in the frequency domain
		int maxIter = 4000;
