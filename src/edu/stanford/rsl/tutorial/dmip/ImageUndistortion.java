...
public class ImageUndistortion{
	...
	public void doImageUndstortion(){
		...
		// adapt the paths
		int caseNo = 0;
		String filename = "/proj/i5dmip/gy27waki/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		
		if(caseNo == 0)
		{
			filename = "/proj/i5dmip/gy27waki/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		}
		else if(caseNo == 1)
		{
			filename = "/proj/i5dmip/gy27waki/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/undistorted.jpg";
		}else if(caseNo == 2)
		{
			filename = "/proj/i5dmip/gy27waki/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame90.jpg";
		}
		...
		for(int i = 0; i < ny; i++)
		{
			for(int j = 0; j < nx; j++)
			{
				...
				Yu2.setElementValue(j, i, Yd.getAtIndex( (int)( (i + 1) * fy), (int) ((j + 1) * fx)));
			}
		}
		...
		for(int r = 0; r < numCorresp; r++)
		{
			...
			for(int i = 0; i <= degree; i++)
			{
				...
				{
					A.setElementValue(r, cc, Math.pow(Xu2_vec.getElement(r), i) * Math.pow(Yu2_vec.getElement(r),i ));
